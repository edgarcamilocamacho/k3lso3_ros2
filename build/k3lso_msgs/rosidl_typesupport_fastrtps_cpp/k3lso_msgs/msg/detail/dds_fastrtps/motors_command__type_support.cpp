...
#include "k3lso_msgs/msg/detail/motors_command__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
  auto typed_message =
    static_cast<const k3lso_msgs::msg::MotorsCommand *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<k3lso_msgs::msg::MotorsCommand *>(
    untyped_ros_message);
...
{
  return &k3lso_msgs::msg::typesupport_fastrtps_cpp::_MotorsCommand__handle;
}
