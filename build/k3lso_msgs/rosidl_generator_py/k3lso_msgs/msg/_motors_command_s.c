...
bool k3lso_msgs__msg__motors_command__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("k3lso_msgs.msg._motors_command.MotorsCommand", full_classname_dest, 44) == 0);
  }
  k3lso_msgs__msg__MotorsCommand * ros_message = _ros_message;
  {  // header
...
PyObject * k3lso_msgs__msg__motors_command__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("k3lso_msgs.msg._motors_command");
