...
static const _MotorsCommand_type_support_symbol_names_t _MotorsCommand_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, k3lso_msgs, msg, MotorsCommand)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, k3lso_msgs, msg, MotorsCommand)),
  }
};
...
{
  return &::k3lso_msgs::msg::rosidl_typesupport_cpp::MotorsCommand_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, k3lso_msgs, msg, MotorsCommand)() {
  return get_message_type_support_handle<k3lso_msgs::msg::MotorsCommand>();
}
